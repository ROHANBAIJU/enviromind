...
Step 2: Install nodejs, python 3.12 or greater, pnpm. (Refer Chatgpt or youtube for tutorials). After Installing veify their installation by running these commands in a teminal, 
python --version
node --version
pnpm --vesion
