...
Step 2: Have nodejs, python 3.12 or greater, pnmp installed.
...
Step 4: Open flaskbackend_app.py and run the script to turn on the backend server, you should see the output in the terminal which says that the server is successfully running.


Step 5: Open another terminal, or in the terminal where you did pnpm install perform "pnpm dev"
